...
Name-US: Color Red
Description-US: Takes a List of Selected Objects and Turns on Use Color, then Sets the color to be 230, 20, 30
"""
...
def main():
    ...
    while (s<len(objList)):
        ...
        objList[s][c4d.ID_BASEOBJECT_COLOR]=c4d.Vector(.902, .078, .118)
        s=s+1
