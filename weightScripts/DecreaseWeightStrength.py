"""
Name-US:DecreaseWeightStrength
Description-US: Decrease the strength of the Weights Manager, Paint Tool, and Weight tool. Without any modifiers
(ie CTRL and CTRL+SHIFT) will decrease strength by 10%. With CTRL-5%, with CTRL+SHIFT-1%. 
