"""
Name-US: CV-Weight +10%
Description-US: Increase the Weight Strength Slider by 10%
"""
...
def main():
    ...
    if strength==1.0:
        ...
        WeightTool[c4d.ID_CA_WEIGHT_TOOL_STRENGTH]=(strength+.1)
        wmgr.SetParameter(doc, c4d.ID_CA_WEIGHT_MGR_WEIGHT_STRENGTH, strength+.1)
        PaintTool[c4d.ID_CA_PAINT_TOOL_OPACITY]=(strength+.1)
