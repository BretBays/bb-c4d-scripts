"""
Name-US: CV-Weight 1%
Description-US: Set the Weight Strength Slider to 1%
"""
...
def main():
    ...
    WeightTool[c4d.ID_CA_WEIGHT_TOOL_STRENGTH]=.01
    wmgr=c4d.modules.character.CAWeightMgr
    strength=wmgr.SetParameter(doc, c4d.ID_CA_WEIGHT_MGR_WEIGHT_STRENGTH, .01)
