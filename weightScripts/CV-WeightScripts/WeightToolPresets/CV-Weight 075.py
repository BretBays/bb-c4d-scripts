"""
Name-US: CV-Weight 75%
Description-US: Set the Weight Strength Slider to 75%
"""
...
def main():
    ...
    WeightTool[c4d.ID_CA_WEIGHT_TOOL_STRENGTH]=.75
    wmgr=c4d.modules.character.CAWeightMgr
    strength=wmgr.SetParameter(doc, c4d.ID_CA_WEIGHT_MGR_WEIGHT_STRENGTH, .75)
